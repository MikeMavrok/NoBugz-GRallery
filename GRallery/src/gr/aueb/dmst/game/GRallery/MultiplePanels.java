...
public class MultiplePanels implements ActionListener{
	...
	public void ConstructAnswers() {
		...
		questions.add("Ποια άλλη διάσημη ζωγράφο που γνωρίζετε σας θυμίζει η εικονιζόμενη;");
		...
		questions.add("Στο πλαίσιο της δημοπρασίας του πίνακα, από τις 20 Νοεμβρίου 2021 και για 4 μέρες οι Γάλλοι \n"
				...
				+ "σχεδόν δύο χλμ. από το Λούβρο. Ο συγκεκριμένος πίνακας θεωρείται \nένα από τα αριστουργήματα της νεοελληνικής τέχνης του 19ου αιώνα.\r\n"
