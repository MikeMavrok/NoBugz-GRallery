...
public class NewWindow implements ActionListener{
	...
	public NewWindow () {
		...
		//δημιουργω τα στοιχεια της ετικετας
		...
		frame.add(label1); //προσθετω την ετικετα στο παραθυρο
		...
		//δημιουργω τα στοιχεια για το νεο παραθυρο
	...
	public void actionPerformed(ActionEvent e) {
		...
		//αν πατηθει το κουμπι τοτε
		if(e.getSource()==	buttonchoises[0] ) {
		//και αν η σωστη απαντηση εινια αυτη τοτε βγαλε μηνυμα ΣΩΣΤΟ
